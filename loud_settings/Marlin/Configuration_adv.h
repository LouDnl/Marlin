...
//
#define ASSISTED_TRAMMING // LouD enable
#if ENABLED(ASSISTED_TRAMMING)

  // Define positions for probing points, use the hotend as reference not the sensor.
  //#define TRAMMING_POINT_XY { {  20, 20 }, { 200,  20 }, { 200, 200 }, { 20, 200 } } // DEFAULT NOT WORKING
  #define TRAMMING_POINT_XY { {  42, 42 }, { 178,  42 }, { 178, 178 }, { 42, 178 } }
   ...
   */
  #define TRAMMING_SCREW_THREAD 40 // DEFAULT 30
...
// @section lcd
  ...
  #define FINE_MANUAL_MOVE 0.025 // (mm) Smallest manual Z move (< 0.1mm) applying to Z on most machines
  //#define FINE_MANUAL_MOVE 0.005 // (mm) Smallest manual Z move (< 0.1mm)
  #if IS_ULTIPANEL
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE   20//6  // (mm/s) Load filament feedrate. This can be pretty fast.
