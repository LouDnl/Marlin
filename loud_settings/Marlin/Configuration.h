...
//#define BAUDRATE 250000 // LOCKS UP DISPLAY, DISPLAY STAYS BLANK
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  25.61,  25.61 }
    #define DEFAULT_Ki_LIST {   2.07,  2.07 }
    #define DEFAULT_Kd_LIST {  79.04,  79.04 }
  #else
    // Ender 3 v2
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //#define DEFAULT_bedKd 624.59
	#define DEFAULT_bedKp 144.01
	#define DEFAULT_bedKi 28.07
	#define DEFAULT_bedKd 492.56
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 103.06 }
 ...
 */
//#define PREHEAT_BEFORE_LEVELING // Disabled as this lowers temp when already at temperature
